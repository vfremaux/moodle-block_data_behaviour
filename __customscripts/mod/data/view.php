...
// CHANGE+
$return = optional_param('return', '', PARAM_TEXT); // page is now used for format page return control.
$fpage = optional_param('page', 0, PARAM_INT); // page is now used for format page control.
// CHANGE-
...
// CHANGE+.
$dbmanager = get_block_data_behaviour_manager();
// CHANGE-.
...
// CHANGE+.
        $submitactions = array('d' => $data->id, 'sesskey' => sesskey(), 'confirm' => '1', 'serialdelete' => $serialiseddata, 'return' => $return);
        $action = new moodle_url('/mod/data/view.php', $submitactions);
        $cancelurl = new moodle_url('/mod/data/view.php', array('d' => $data->id, 'return' => $return));
// CHANGE-.
